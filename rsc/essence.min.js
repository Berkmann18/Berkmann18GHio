...
return e},this.update=function(){for(var t=$e("*script"),e=0;e<t.length;e++)t[e].src.indexOf(this.name+".js")>-1?t[e].src="http://berkmann18.github.io/rsc/modules/"+this.name+".js":t[e].src.indexOf(this.name+".min.js")>-1&&(t[e].src="http://berkmann18.github.io/rsc/modules/"+this.name+".min.js")
Essence.say(this.name.capitalize()+"%(.min).js%c has been updated","succ","text-decoration: underline","text-decoration: none")},this}function require(t,e,r){if(isType(t,"Array"))for(var i=0;i<t.length;i++)require(t[i],e)
...
e.innerText=t,e.type="text/javascript",$n("head").appendChild(e)}else $e("script[type='text/javascript']").after(t)},update:function(){for(var t=$e("*script"),e=0;e<t.length;e++)(t[e].src.indexOf("essence.js")>-1||t[e].src.indexOf("essence.min.js")>-1)&&(t[e].src=this.source||Essence.source)
